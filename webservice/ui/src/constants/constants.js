...
export const SETTINGS = {
  CAMERA_FEED_SERVER: "http://localhost:3004", //"https://" + WS_HOST + "-3004.udacity-student-workspaces.com",
...
export const MQTT = {
  MQTT_SERVER: "ws://localhost:3002", //"wss://" + WS_HOST + "-3002.udacity-student-workspaces.com",
  TOPICS: {
